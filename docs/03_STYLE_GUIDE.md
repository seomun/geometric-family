...
| 눈 | 흰자 + INK 동공 + 하이라이트 2개(큰 것 좌상, 작은 것 우하). 위치 = 얼굴 중심 −2, 간격 ±16 |
| 얼굴 크기 | 몸 폭 100 기준 스케일 1 × 1.12 (내부 고정). 몸이 커져도 비율 유지 |
| 팔다리 | 몸 색과 같은 색, 외곽선 있음. 팔 폭 0.15u, 다리 폭 0.15u, 손 반지름 0.105u, 발 = 몸색 35% 어둡게 |
| 다리 길이 | 몸 아래 0.09u (짧고 뭉툭) |
